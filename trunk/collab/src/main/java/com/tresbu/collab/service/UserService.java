...
import com.tresbu.collab.repository.AuthorityRepository;
...
import com.tresbu.collab.service.util.RandomUtil;
...
public class UserService {
    ...
    public User createUser(String login, String password, String firstName, String lastName, String email,
        ...
        newUser.setTenant(SecurityUtils.getCurrentUserTenant());
    ...
    public User createUser(Tenant tenant) {
        User user = new User();
        user.setLogin(tenant.getName());
        user.setFirstName(tenant.getName());
        user.setLastName(tenant.getOrganization());
        user.setEmail(tenant.getEmail());
        user.setLangKey("en");
         Set<Authority> authorities = new HashSet<>();
         authorities.add(authorityRepository.findOne(AuthoritiesConstants.USER_ADMIN));
         user.setAuthorities(authorities);
       // }
        String encryptedPassword = passwordEncoder.encode(RandomUtil.generatePassword());
        user.setPassword(encryptedPassword);
