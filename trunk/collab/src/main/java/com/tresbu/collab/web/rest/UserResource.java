...
import com.tresbu.collab.config.Constants;
...
import com.tresbu.collab.service.mapper.UserMapper;
import com.tresbu.collab.web.rest.vm.ManagedUserVM;
...
public class UserResource {
    ...
    public ResponseEntity<UserUIDTO> getUser(@PathVariable String login) {
    	 ...
    	 *  And also do not add RBAC for this API because super admin may access this api in trakeye
    	 * 
    	 */
        ...
        Optional<User> managedUserVM =userService.getUserWithAuthoritiesByLogin(login);
        if(managedUserVM.isPresent()){
        	UserUIDTO user = userMapper.userToUserUIDTO(managedUserVM.get());
